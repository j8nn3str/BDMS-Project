...
with open('sql/q4.sql', 'r') as myfile:
    query=myfile.read()
  ...
  <div class="col-lg-12">
    <form action="query.py" method="POST">
        <div class="form-group">
            <label for="query-text-area">Find the tickers of all stocks in 'NYSE' whose closing price on '3/20/2017' was either strictly below $20 or above $100.</label>
"""
