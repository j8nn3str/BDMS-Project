...
with open('sql/q6.sql', 'r') as myfile:
    query=myfile.read()
  ...
  <div class="col-lg-12">
    <form action="query.py" method="POST">
        <div class="form-group">
            <label for="query-text-area">Find the dates where the total price (i.e. price times num of shares) of 'AAPL' the firm (i.e. the trading firm which is using this database) sold was higher than what the firm bought in 'NASDAQ'.</label>
"""
