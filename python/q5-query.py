...
with open('sql/q5.sql', 'r') as myfile:
    query=myfile.read()
  ...
  <div class="col-lg-12">
    <form action="query.py" method="POST">
        <div class="form-group">
            <label for="query-text-area">Find the tickers of the stocks whose closing price showed the highest increase between '3/20/2016' and '3/21/2016' in 'NYSE' and whose closing price was above $100 for the entire 2017</label>
"""
